...
- **Daily notes** are auto-created by the `daily-briefing` skill at the start of each day
- **Weekly reviews** are auto-generated by the `weekly-review` skill on Sundays

## Why a folder, not Obsidian / Notion / Things?
